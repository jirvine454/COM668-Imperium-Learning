...
@Component({
  selector: 'app-bd-questions',
  templateUrl: './bd-questions.component.html',
  styleUrls: ['./bd-questions.component.css']
})
export class BdQuestionsComponent implements OnInit {
  ...
  getAllQuestions() {
    this.assessmentService.getBDQuestions()
      .subscribe(res => {
